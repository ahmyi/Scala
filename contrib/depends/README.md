...
To build with the x86_64-apple-darwin12 you require the mac os developer tools in MacOSX10.12.sdk. 
Download it from apple, or search for it on github. Create a new directoty called SDKs in this
directory and place the entire MacOSX10.12.sdk folder in it. The depends build will then pick it up automatically
